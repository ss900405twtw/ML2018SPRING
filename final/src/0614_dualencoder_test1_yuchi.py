...
from keras.layers import Dense,Dropout,LSTM,Embedding,Input,multiply,merge
...
def dual_encoder(sequence_length,embedding_matrix,input_dim):
    ...
    model.add(LSTM(units=300, activation='tanh', dropout=0.3, recurrent_dropout=0.3, return_sequences=False))
...
f = open('0614_dualencoder_test_yuchi.csv','w')
f.write('id,ans\n')
