...
def dual_encoder(sequence_length,embedding_matrix,input_dim):
    ...
    model.add(LSTM(units=200, activation='tanh',dropout=0.2,recurrent_dropout=0.2, return_sequences=True))
    model.add(GRU(units=200, activation='tanh',dropout=0.4,recurrent_dropout=0.4, return_sequences=False))
